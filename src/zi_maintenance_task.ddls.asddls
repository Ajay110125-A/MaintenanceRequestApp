...
define view entity ZI_MAINTENANCE_TASK
  ...
  association        to parent ZI_MAINTENANCE_REQ as _Main   on $projection.RequestId = _Main.RequestId
  ...
  association [1..1] to ZI_STATUS_INFO_AY         as _Status on _Task.task_status = _Status.StatusId
{
  key task_id                                                 as TaskId,
      ...
      concat_with_space( _Tech.FirstName, _Tech.LastName, 1 ) as TechnicianName,
